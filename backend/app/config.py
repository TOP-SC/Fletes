...
# Planillas cross en Google Drive.
# label = nombre legible en la UI; filename = nombre en data/cross_inbox/
CROSS_PLANILLAS_DRIVE: list[dict[str, str | bool]] = [
    ...
    {
        "label": "Alfaro — Salta / Jujuy / Tucumán",
